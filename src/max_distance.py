...
boxplot = read_df.boxplot(column='graph_diameter', by='dataset', rot=45, grid=False, figsize=(16, 12), fontsize=12)
...
#    set labels
boxplot.set_xlabel('dataset', fontdict={'fontsize': 14})
boxplot.set_ylabel('graph_diameter', fontdict={'fontsize': 15})
