...
def kernelize_graph(unique_graphindicator, edges_asdf, filtr_range, filtration, dataset, graphindicator, iter, progress,
    ...
    for graphid in unique_graphindicator:
        ...
        upper_diag = wl_transform[np.triu_indices(len(wl_transform), k=1)]  #obtain the flattened upper diagonal of the Gram(kernel) matrix
        feature_matrix.append(upper_diag) #append to the feature matrix
...
if __name__ == '__main__':
    ...
    outputFile = "/home/taiwo/projects/def-cakcora/taiwo/results3/" + 'Kernel_TDAUpper.csv'
