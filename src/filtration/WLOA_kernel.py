...
def operate_kernel(unique_graph_indicator, df_edges, graph_indicators, nodes_dict, graph_labels, iter_):
    ...
    wloa = WeisfeilerLehmanOptimalAssignment(n_iter=iter_, verbose=True, normalize=True)
    train_data = wloa.fit_transform(g_train)
    test_data = wloa.transform(g_test)
...
if __name__ == '__main__':
    ...
    outputFile = "/home/taiwo/projects/def-cakcora/taiwo/result/" + 'WLOAresults.csv'
