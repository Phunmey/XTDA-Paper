...
def landscape_train(x_train, graph_indicators, df_edges):  # this is for the train data
    ...
    df1 = pd.DataFrame(np.concatenate(train_silhouette))
...
def landscape_test(x_test, graph_indicators, df_edges, train_time):  # this is for the train test
    ...
    df1_ = pd.DataFrame(np.concatenate(test_silhouette))
...
def main():
    ...
    test_data, silhouette_time = landscape_test(x_test, graph_indicators, df_edges, train_time)
...
if __name__ == '__main__':
    ...
    outputFile = "/home/taiwo/projects/def-cakcora/taiwo/results3/" + 'Alpha_MSgraph.csv'
