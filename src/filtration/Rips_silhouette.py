...
def main():
    ...
    train_data, test_data, silhouette_time = landscape_test(x_test, graph_indicators, df_edges, train_time,
                                                            train_silhouette)
...
if __name__ == '__main__':
    ...
    outputFile = "/home/taiwo/projects/def-cakcora/taiwo/result/" + 'Rips_silhouette.csv'
