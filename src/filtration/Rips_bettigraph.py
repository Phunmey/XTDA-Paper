...
def random_forest(dataset, Param_Grid, train_data, test_data, y_train, y_test, ripser_time, num_cv):
...
def main():
    ...
    random_forest(dataset, Param_Grid, train_data, test_data, y_train, y_test, ripser_time,num_cv)
...
if __name__ == '__main__':
    ...
    outputFile = "/home/taiwo/projects/def-cakcora/taiwo/results3/" + 'Rips_bettigraph.csv'
