...
def main():
    ...
    train_landscape, train_time, sample_range = landscape_train(X_train, graph_indicators, df_edges, step_size)
    train_data, test_data, landscape_time = landscape_test(X_test, graph_indicators, df_edges, sample_range, train_time,
                                                           train_landscape)
...
if __name__ == '__main__':
    ...
    outputFile = "/home/taiwo/projects/def-cakcora/taiwo/results3/" + 'Alpha_PPL.csv'
