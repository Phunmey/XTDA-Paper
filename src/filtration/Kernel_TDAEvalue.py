...
def kernelize_graph(unique_graphindicator, edges_asdf, filtr_range, filtration, dataset, graphindicator, iter, progress,
    ...
    for graphid in unique_graphindicator:
        ...
        eigen_value, eigen_vector = np.linalg.eig(wl_transform)  #obtain the eigenvalues of the Gram(kernel) matrix
...
if __name__ == '__main__':
    ...
    outputFile = "/home/taiwo/projects/def-cakcora/taiwo/results3/" + 'Kernel_TDAEvalue.csv'
