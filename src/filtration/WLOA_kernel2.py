...
def operate_kernel(unique_graph_indicator, df_edges, graph_indicators, nodes_dict, graph_labels, iter_):
    ...
    WL = WeisfeilerLehmanOptimalAssignment(n_iter=iter_, verbose=True, normalize=True)
...
if __name__ == '__main__':
    ...
    outputFile = "/home/taiwo/projects/def-cakcora/taiwo/results3/" + 'WLOAresults2.csv'
