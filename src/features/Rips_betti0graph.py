...
def main():
    ...
    test_data, alpha_time, total_betti = alpha_test(X_test, thresh, graph_indicators, df_edges, step_size, train_time,
                                                    h_0)
...
if __name__ == '__main__':
    ...
    outputFile = "/home/taiwo/projects/def-cakcora/taiwo/results3/" + 'Rips_betti0graph.csv'
